        ...
        for seed in seeds:
            ...
            for i in xrange(catValAmount):
                ...
                if key1 == 'small':
                    ...
                    if key1 == 'medium':
                        boundV=random.randint(1,2)
                    else:
                        boundV=random.randint(1,3)
            ...
            model.write(directory+param.name+"_friction.lp")
            ...
            model.write(directory+param.name+"_friction_DA.lp")
            
            for i in range(demandIds[-1]+1,demandIds[-1]+taskAmount+1):
                attributes[i].frictionSteps=[-1000,1000]
            ...
            model.write(directory+param.name+"_no_friction.lp")
            ...
            model.write(directory+param.name+"_no_friction_DA.lp")